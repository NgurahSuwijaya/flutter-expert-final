...
class _HomeMoviePageState extends State<HomeMoviePage> {
  ...
  void initState() {
    ...
    Future.microtask(()
    {
      context.read<NowPlayingMoviesBloc>().add(OnNowPlayingMoviesEvent());
      context.read<TopRatedMoviesBloc>().add(OnTopRatedMoviesEvent());
      context.read<PopularMoviesBloc>().add(OnPopularMoviesEvent());
    });
  }
